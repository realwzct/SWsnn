...
objects = $(OBJ)/swtest.o $(OBJ)/mypbuf.o $(OBJ)/setupNetwork.o $(OBJ)/runNetwork_sw.o $(OBJ)/runNetwork_sl_mpi.o $(OBJ)/my_slave.o $(OBJ)/dmaWait.o
...
run: 
	bsub -b -I -q q_sw_share -n 56 -np 4 -cgsp 64 -host_stack 256 -share_size 4096 $(OBJ)/main 10000 200000 2 0.125 1000 5.5
clean:
	rm $(OBJ)/*.o
	rm $(OBJ)/$(EXE)
